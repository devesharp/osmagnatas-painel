...
export const editorTheme: EditorThemeClasses = {
  ...
  rtl: "text-right",
  heading: {
    h1: "scroll-m-20 text-[30px] font-semibold tracking-tight",
    h2: "scroll-m-20 text-[26px] font-semibold tracking-tight first:mt-0",
    h3: "scroll-m-20 text-[22px] font-semibold tracking-tight",
    h4: "scroll-m-20 text-[20px] font-semibold tracking-tight",
    h5: "scroll-m-20 text-[18px] font-semibold tracking-tight",
    h6: "scroll-m-20 text-[16px] font-semibold tracking-tight",
  },
